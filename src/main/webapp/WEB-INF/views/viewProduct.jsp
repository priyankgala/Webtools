...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="container" ng-app = "cartApp">
            <div class="row">
                <div class="col-md-5">
                    <img src="<spring:url value="/resources/images/${product.productId}.png" />" alt="image" style="width:70%"/>
                </div>
                <div class="col-md-5">
                    <h3>${product.productName}</h3>
                    <p><strong>Manufacturer</strong>Priyav Umbrella's</p>
                    ...
                    <p ng-controller="cartCtrl">
                        <a href="<c:url value = "/admin/productInventory.htm" />" class="btn btn-default">Back</a>
